...
import { CheckCircle2, Server, Smartphone, Cloud, Users, MonitorCheck, Database, Lock, ShieldCheck, Laptop, Building2, UserCircle, Bell, LayoutGrid, Cpu, Globe, Key } from 'lucide-react';
  ...
  return (
    <div className="bg-surface w-full overflow-x-hidden pt-20">
      ...
      {/* ========================================================
         ...
         ======================================================== */}
      <section className="relative w-full px-6 md:px-24 py-24 md:py-32 bg-[#F8F9FA] border-b border-gray-200 flex flex-col justify-center min-h-[70vh] overflow-hidden items-center text-center">
         
         <div className="relative z-10 w-full max-w-5xl">
            <div className={`transition-all duration-1000 transform ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
      ...
      <section className="py-24 px-6 md:px-24 bg-[#0B1221] text-white relative overflow-hidden">
         ...
         <div className="relative z-10 max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-16">
               ...
               {/* Text Content - Architecture Specs */}
