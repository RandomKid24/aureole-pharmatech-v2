  ...
  return (
    <div className="bg-surface w-full overflow-x-hidden pt-16 md:pt-20">
      ...
      {/* ========================================================
         ...
         ======================================================== */}
      <section className="py-12 md:py-24 px-5 md:px-12 bg-surface">
        <div className="max-w-[1920px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 border-t border-l border-gray-200 bg-white shadow-sm">
            {SERVICE_FEATURES.map((feature, idx) => {
               ...
               return (
                 <div key={idx} className="group relative p-6 md:p-10 border-r border-b border-gray-200 hover:bg-surface transition-colors duration-500 min-h-[auto] md:min-h-[340px] flex flex-col justify-between overflow-hidden">
                    ...
                    <div className="relative z-10 flex justify-between items-start mb-6">
                       ...
                       <span className="text-2xl md:text-4xl font-black text-gray-100 group-hover:text-gray-200 transition-colors duration-500 select-none">
                          0{idx + 1}
                       </span>
                    </div>
                    ...
                    <div className="mt-6 md:mt-0 flex md:absolute md:bottom-6 md:right-6 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all duration-500 transform translate-x-0 md:translate-x-4 md:group-hover:translate-x-0">
         ...
         <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-6">
               {SERVICE_LOCATIONS.map((loc, idx) => (
                  <div key={idx} className="group cursor-default flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/5 hover:border-aureole/30 hover:bg-white/10 transition-all duration-300">
